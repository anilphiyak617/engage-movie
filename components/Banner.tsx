...
const Banner = ({ netflixOriginals }: BannerProps) => {
    ...
    return (
        <div className=' flex flex-col space-y-2 py-28  md:space-y-4 lg:h[65vh] lg:pl-16 '>
            ...
            <p className='max-w-xs text-xs md:max-w-lg md:text-lg lg:max-w-2xl lg:text-2xl'>{bannerMovie?.overview}</p>
            <div className='flex space-x-3'>
                <button className='bannerButton bg-white text-black' ><IoMdPlay className='w-4 h-4 text-black md:h-8 md:w-8' />Play</button>
                <button className='bannerButton bg-[gray]/60'>More Info</button>
            </div>
        </div>
    )
}
